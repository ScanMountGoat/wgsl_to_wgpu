...
impl State {
    async fn new(window: Window) -> Self {
        ...
        let compute_pipeline = compute::compute::create_main_pipeline(&device);
        ...
        let compute_bind_group = compute::bind_groups::BindGroup0::from_bindings(
            &device,
    ...
    fn render(&mut self) -> Result<(), wgpu::SurfaceError> {
        ...
        compute::set_bind_groups(&mut compute_pass, &self.compute_bind_group);
